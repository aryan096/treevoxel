...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    params: {
      ...
      branchDroop: 0.14, apicalDominance: 0.16,
  ...
  },
  {
    ...
    params: {
      ...
      height: 15, crownWidth: 10, crownDepth: 0.84, trunkBaseRadius: 1.25,
  ...
  },
  {
    id: 'crazy',
    name: 'Crazy',
    description: 'Intentional wild-card preset pushed further into unstable fantasy territory with harder lean, stranger branching, and a much taller canopy stack.',
    ...
    params: {
      ...
      height: 40, crownWidth: 22, crownDepth: 0.78, trunkBaseRadius: 1.9,
      trunkTaper: 0.46, trunkLean: 16, trunkLeanDirection: 298, clearTrunkHeight: 0.16, trunkCurvature: 0.42, trunkNoise: 0.46,
      primaryBranchCount: 10, branchAngle: 68, branchAngleVariance: 26,
      branchLengthRatio: 1.18, branchOrderDepth: 3, branchDensity: 0.9,
      branchDroop: 0.32, apicalDominance: 0.04,
      crownShape: 'irregular', crownFullness: 0.9, leafClusterRadius: 2.8,
      leafDensity: 0.88, interiorLeafPruning: 0.16,
      minBranchThickness: 1, leafCleanup: 1, symmetryAssist: 0, buildabilityBias: 0.5,
    },
  },
];
