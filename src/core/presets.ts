...
export const PRESETS: Preset[] = [
  {
    ...
    params: {
      ...
      trunkTaper: 0.85, trunkLean: 0, clearTrunkHeight: 0.15, trunkCurvature: 0.05,
  ...
  },
  {
    ...
    params: {
      ...
      trunkTaper: 0.6, trunkLean: 0, clearTrunkHeight: 0.35, trunkCurvature: 0.15,
  ...
  },
  {
    ...
    params: {
      ...
      trunkTaper: 0.5, trunkLean: 3, clearTrunkHeight: 0.25, trunkCurvature: 0.2,
